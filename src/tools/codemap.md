...
The `src/tools/` directory provides the core tool implementations for the oh-my-oc plugin. It exposes three main categories of tools:
...
- **Install location**: `~/.cache/oh-my-oc/bin/sg` (Linux/macOS), `%LOCALAPPDATA%\oh-my-oc\bin\sg.exe` (Windows)
